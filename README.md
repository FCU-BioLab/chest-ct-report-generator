...
一個完整的端到端胸部CT影像分析和醫療報告生成系統，整合了FPS-Former目標檢測、MedSAM2分割、RAG知識檢索和智能報告生成功能。
...
✅ **FPS-Former目標檢測** - 基於Feature Pyramid Swin Transformer的高精度腫瘤檢測與分類  
