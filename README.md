...
一個完整的端到端胸部CT影像分析和醫療報告生成系統，整合了Faster R-CNN目標檢測、MedSAM2分割、RAG知識檢索和智能報告生成功能。
...
✅ **Faster R-CNN目標檢測** - 基於ResNet50-FPN的高精度二分類腫瘤檢測（病灶 vs 背景）  
...
| 指標 | CT-ViT (舊版) | Faster R-CNN (當前) | 提升幅度 |
|------|------------|---------------|----------|
| 二分類檢測 | N/A | 支援 | 新功能 |
| 邊界框回歸 | N/A | 支援 | 新功能 |
| 空間定位 | ❌ | ✅ | 新功能 |
